    ...
    return (
        ...
        >
            {user ? (
                <div className=" group flex items-center">
                    ...
                    <p className="hidden md:inline-block text-primary mx-1 text-sm group-hover:text-[#5296dd]">{user.displayName
        ...
        >
            <ul
             ...
             aria-labelledby="dropdownDefaultButton"
            >
            <li className="px-2 group w-40 dark:hover:bg-gray-600 rounded-lg"
            onClick={()=>{
